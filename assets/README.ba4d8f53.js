var A=Object.defineProperty,x=Object.defineProperties;var y=Object.getOwnPropertyDescriptors;var F=Object.getOwnPropertySymbols;var C=Object.prototype.hasOwnProperty,f=Object.prototype.propertyIsEnumerable;var b=(t,n,r)=>n in t?A(t,n,{enumerable:!0,configurable:!0,writable:!0,value:r}):t[n]=r,o=(t,n)=>{for(var r in n||(n={}))C.call(n,r)&&b(t,r,n[r]);if(F)for(var r of F(n))f.call(n,r)&&b(t,r,n[r]);return t},s=(t,n)=>x(t,y(n));var B=(t,n)=>{var r={};for(var l in t)C.call(t,l)&&n.indexOf(l)<0&&(r[l]=t[l]);if(t!=null&&F)for(var l of F(t))n.indexOf(l)<0&&f.call(t,l)&&(r[l]=t[l]);return r};import{j as e,c as I,r as E,a as u,F as S}from"./main.8f424eb4.js";import{dS as g,F as D,aa as w,d9 as P,a as R,cA as V,a0 as N,b4 as k,cY as z,a9 as _,dw as i,C as O,dy as c,d6 as p,j as M,dz as U}from"./index.b3fd8e8c.js";import{h as G}from"./index.98055ee8.js";var j=t=>e(g,s(o({className:"demo-floating-box-bubble",offset:{right:20,bottom:20},style:{"--rv-floating-box-size":"60px"},adsorb:{indent:.5,distance:20}},t),{children:e(D,{align:"center",justify:"center",className:"main-button",children:e(w,{})})}));const L=[V,N,k,z,_];var T=r=>{var l=r,{menu:t={}}=l,n=B(l,["menu"]);return e(g,s(o({className:"demo-floating-box-menu",offset:{right:20,bottom:"14vh"},menu:s(o({},t),{items:L.map((h,m)=>e(D,{align:"center",justify:"center",onClick:()=>P.info(`\u70B9\u51FB\u4E86\u7B2C${m+1}\u4E2A`),className:"menu-item",children:e(h,{})},m))})},n),{children:({active:h})=>e(D,{align:"center",justify:"center",className:I("main-button",{"main-button--active":h}),children:e(R,{})})}))};var v=()=>{const[t]=i.useForm(),[n,r]=E.exports.useState(0),[l,h]=E.exports.useState({}),m=()=>r(a=>a+1);return G.useUpdateEffect(()=>{(async()=>{const d=await t.getFieldsValue();d.adsorb_show||(d.adsorb=!1),delete d.adsorb_show,h(d)})()},[n]),u("div",{className:"demo-floating-box",children:[e(O,{title:"\u8BBE\u7F6E\u60AC\u6D6E\u7403"}),u(i,{form:t,onValuesChange:m,children:[e(i.Item,{name:"type",label:"DEMO",initialValue:"0",children:u(c.Group,{children:[e(c,{name:"0",children:"\u666E\u901A\u60AC\u6D6E\u7403"}),e(c,{name:"1",children:"\u5E26\u83DC\u5355\u7684\u60AC\u6D6E\u7403"})]})}),e(i.Item,{valuePropName:"checked",name:"disabled",label:"\u7981\u7528",initialValue:!1,children:e(p,{size:20})}),e(i.Item,{valuePropName:"checked",name:"draggable",label:"\u62D6\u52A8",initialValue:!0,children:e(p,{size:20})}),e(i.Item,{tooltip:"\u62D6\u52A8\u7ED3\u675F\u540E\uFF0C\u4F1A\u5438\u9644\u5728\u66F4\u9760\u8FD1\u7684\u5C4F\u5E55\u4E00\u4FA7",valuePropName:"checked",name:"adsorb_show",label:"\u8FD1\u8FB9\u505C\u9760",initialValue:!0,children:e(p,{size:20})}),e(i.Item,{noStyle:!0,shouldUpdate:(a,d)=>a.adsorb_show!==d.adsorb_show,children:()=>t.getFieldValue("adsorb_show")?u(S,{children:[e(i.Item,{tooltip:"\u5438\u9644\u5728\u5C4F\u5E55\u4E00\u4FA7\u65F6\u8DDD\u79BB\u4FA7\u8FB9\u7684\u8DDD\u79BB",name:["adsorb","distance"],label:"\u505C\u9760\u8DDD\u79BB",initialValue:20,children:e(M,{rightIcon:e("div",{children:"PX"})})}),e(i.Item,{tooltip:"\u6EDA\u52A8\u65F6\u60AC\u6D6E\u7403\u79FB\u52A8\u5230\u5C4F\u5916\u7684\u6BD4\u7387",name:["adsorb","indent"],label:"\u6EDA\u52A8\u7F29\u8FDB",initialValue:.5,children:e(U,{min:0,max:1,step:.1})})]}):null}),e(i.Item,{noStyle:!0,shouldUpdate:(a,d)=>a.type!==d.type,children:()=>+t.getFieldValue("type")==0?null:e(i.Item,{name:["menu","direction"],label:"\u83DC\u5355\u5C55\u5F00\u65B9\u5411",initialValue:"around",children:u(c.Group,{children:[e(c,{name:"around",children:"around"}),e(c,{name:"vertical",children:"vertical"}),e(c,{name:"horizontal",children:"horizontal"})]})})})]}),+l.type==1?e(T,o({},l)):e(j,o({},l)),e("div",{style:{height:1e3}})]})};const H=`import React, { useState } from 'react';
...
`,W={code:H,lang:"tsx",dependencies:{react:{type:"NPM",value:">=16.14.0"},"react-vant":{type:"NPM",value:"2.0.0-alpha.39"},"@react-vant/icons":{type:"NPM",value:"0.0.6"},clsx:{type:"NPM",value:"1.1.1"},"index.tsx":{type:"FILE",value:`import React, { useState } from 'react';
import { Cell, Field, Stepper, Form, Switch, Radio, hooks } from 'react-vant';
import type { FloatingBallProps } from 'react-vant';
import Bubble from './bubble';
import Menu from './menu';
