var w=Object.defineProperty,U=Object.defineProperties;var b=Object.getOwnPropertyDescriptors;var E=Object.getOwnPropertySymbols;var z=Object.prototype.hasOwnProperty,j=Object.prototype.propertyIsEnumerable;var m=(t,r,n)=>r in t?w(t,r,{enumerable:!0,configurable:!0,writable:!0,value:n}):t[r]=n,a=(t,r)=>{for(var n in r||(r={}))z.call(r,n)&&m(t,n,r[n]);if(E)for(var n of E(r))j.call(r,n)&&m(t,n,r[n]);return t},l=(t,r)=>U(t,b(r));import{j as e,r as s,a as u}from"./main.8f424eb4.js";import{dA as i,d9 as v,B as I}from"./index.b3fd8e8c.js";var C=()=>e(i,{afterRead:t=>console.log(t)});const P={code:`import React from 'react';
import { Uploader } from 'react-vant';

export default () => <Uploader afterRead={(file) => console.log(file)} />;`,lang:"jsx",dependencies:{react:{type:"NPM",value:"18.1.0"},"react-vant":{type:"NPM",value:"2.0.0-alpha.39"},"index.jsx":{type:"FILE",value:`import React from 'react';
import { Uploader } from 'react-vant';
...
`,S={code:V,lang:"tsx",dependencies:{react:{type:"NPM",value:"18.1.0"},"react-vant":{type:"NPM",value:"2.0.0-alpha.39"},"index.tsx":{type:"FILE",value:`import React, { useState } from 'react';
import type { UploaderFileListItem } from 'react-vant';
import { Uploader } from 'react-vant';
import { previewData } from './data';
import './style.less';
...
`,M={code:L,lang:"tsx",dependencies:{react:{type:"NPM",value:"18.1.0"},"react-vant":{type:"NPM",value:"2.0.0-alpha.39"},"index.tsx":{type:"FILE",value:`import React, { useState } from 'react';
import { Uploader } from 'react-vant';
import type { UploaderFileListItem } from 'react-vant';
import { statusData } from './data';
...
`,N={code:_,lang:"tsx",dependencies:{react:{type:"NPM",value:"18.1.0"},"react-vant":{type:"NPM",value:"2.0.0-alpha.39"},"index.tsx":{type:"FILE",value:`import React, { useState } from 'react';
import { Uploader } from 'react-vant';
import type { UploaderFileListItem } from 'react-vant';
import { previewData } from './data';
...
`}},key:"uploader-maxcount",meta:{title:"\u9650\u5236\u4E0A\u4F20\u6570\u91CF"}};var B=()=>{const[t,r]=s.exports.useState(p),n=d=>{console.log(d),v("\u6587\u4EF6\u5927\u5C0F\u4E0D\u80FD\u8D85\u8FC7 5kb")};return e(i,{multiple:!0,value:t,onChange:r,maxSize:5*1024,onOversize:n})};const T=`import React, { useState } from 'react';
import type { UploaderFileListItem } from 'react-vant';
...
`,$={code:T,lang:"tsx",dependencies:{react:{type:"NPM",value:"18.1.0"},"react-vant":{type:"NPM",value:"2.0.0-alpha.39"},"index.tsx":{type:"FILE",value:`import React, { useState } from 'react';
import type { UploaderFileListItem } from 'react-vant';
import { Toast, Uploader } from 'react-vant';
import { previewData } from './data';
...
`,W={code:H,lang:"tsx",dependencies:{react:{type:"NPM",value:"18.1.0"},"react-vant":{type:"NPM",value:"2.0.0-alpha.39"},"index.tsx":{type:"FILE",value:`import React, { useState } from 'react';
import type { UploaderFileListItem } from 'react-vant';
import { Uploader } from 'react-vant';
import { previewData } from './data';
import './previewCoverRender.less';
...
`}},key:"uploader-previewcoverrender",meta:{title:"\u81EA\u5B9A\u4E49\u9884\u89C8\u6837\u5F0F"}};var y=()=>{const[t,r]=s.exports.useState([]);return e(i,{multiple:!0,value:t,onChange:r,beforeRead:async d=>{const o=Array.isArray(d)?d:[d];return new Promise(F=>{const h=o.filter(c=>c.type!=="image/jpeg"?(v.info(`${c.name}\u683C\u5F0F\u9519\u8BEF\uFF0C\u8BF7\u4E0A\u4F20 jpg \u683C\u5F0F\u56FE\u7247`),!1):!0);F(h)})}})};const q=`import React, { useState } from 'react';
import { Toast, Uploader } from 'react-vant';
import type { UploaderFileListItem } from 'react-vant';
...
`,G={code:q,lang:"tsx",dependencies:{react:{type:"NPM",value:"18.1.0"},"react-vant":{type:"NPM",value:"2.0.0-alpha.39"},"index.tsx":{type:"FILE",value:`import React, { useState } from 'react';
import { Toast, Uploader } from 'react-vant';
import type { UploaderFileListItem } from 'react-vant';
