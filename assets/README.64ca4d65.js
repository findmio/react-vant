...
`,I={code:P,lang:"tsx",dependencies:{react:{type:"NPM",value:"18.1.0"},"react-vant":{type:"NPM",value:"2.0.0-alpha.34"},"index.tsx":{type:"FILE",value:`/* eslint-disable no-console */
import React from 'react';
import { Checkbox } from 'react-vant';
import './style.less';
...
`,V={code:z,lang:"tsx",dependencies:{react:{type:"NPM",value:"18.1.0"},"react-vant":{type:"NPM",value:"2.0.0-alpha.34"},"index.tsx":{type:"FILE",value:`import React from 'react';
import { Checkbox } from 'react-vant';
import './custom.less';
...
`}},key:"checkbox-custom",meta:{title:"\u81EA\u5B9A\u4E49"}};var E=()=>{const[c,d]=h.exports.useState(!1);return e("div",{className:"demo-checkbox",children:e(r,{checked:c,onChange:t=>{s.loading({forbidClick:!0,duration:0}),setTimeout(()=>{s.clear(),d(t)},500)},children:"\u590D\u9009\u6846"})})};const w=`import React, { useState } from 'react';
...
`,$={code:w,lang:"tsx",dependencies:{react:{type:"NPM",value:"18.1.0"},"react-vant":{type:"NPM",value:"2.0.0-alpha.34"},"index.tsx":{type:"FILE",value:`import React, { useState } from 'react';
import { Checkbox, Toast } from 'react-vant';
...
`,L={code:T,lang:"tsx",dependencies:{react:{type:"NPM",value:"18.1.0"},"react-vant":{type:"NPM",value:"2.0.0-alpha.34"},"index.tsx":{type:"FILE",value:`/* eslint-disable no-console */
import React from 'react';
import { Checkbox } from 'react-vant';
...
`,j={code:O,lang:"tsx",dependencies:{react:{type:"NPM",value:"18.1.0"},"react-vant":{type:"NPM",value:"2.0.0-alpha.34"},"index.tsx":{type:"FILE",value:`import React from 'react';
import { Checkbox } from 'react-vant';
...
`,H={code:q,lang:"tsx",dependencies:{react:{type:"NPM",value:"18.1.0"},"react-vant":{type:"NPM",value:"2.0.0-alpha.34"},"index.tsx":{type:"FILE",value:`import React from 'react';
import { Checkbox } from 'react-vant';
...
`,K={code:J,lang:"tsx",dependencies:{react:{type:"NPM",value:"18.1.0"},"react-vant":{type:"NPM",value:"2.0.0-alpha.34"},"index.tsx":{type:"FILE",value:`import React, { useRef, useState } from 'react';
import { Checkbox, Button } from 'react-vant';
import { CheckboxGroupInstance } from '../PropsType';
...
`,U={code:Q,lang:"tsx",dependencies:{react:{type:"NPM",value:">=16.14.0"},"react-vant":{type:"NPM",value:"2.0.0-alpha.34"},"@react-vant/icons":{type:"NPM",value:"0.0.6"},"index.tsx":{type:"FILE",value:`import React, { useState } from 'react';
import { Checkbox, Cell } from 'react-vant';
import { ShopO } from '@react-vant/icons';
