var B=Object.defineProperty,w=Object.defineProperties;var x=Object.getOwnPropertyDescriptors;var h=Object.getOwnPropertySymbols;var M=Object.prototype.hasOwnProperty,g=Object.prototype.propertyIsEnumerable;var p=(n,d,t)=>d in n?B(n,d,{enumerable:!0,configurable:!0,writable:!0,value:t}):n[d]=t,o=(n,d)=>{for(var t in d||(d={}))M.call(d,t)&&p(n,t,d[t]);if(h)for(var t of h(d))g.call(d,t)&&p(n,t,d[t]);return n},i=(n,d)=>w(n,x(d));import{r as l,a as u,j as e}from"./main.8f424eb4.js";import{dF as r,C as s,d6 as m}from"./index.b3fd8e8c.js";const c=[{text:"\u5168\u90E8\u5546\u54C1",value:0},{text:"\u65B0\u6B3E\u5546\u54C1",value:1},{text:"\u6D3B\u52A8\u5546\u54C1",value:2}],a=[{text:"\u9ED8\u8BA4\u6392\u5E8F",value:"a"},{text:"\u597D\u8BC4\u6392\u5E8F",value:"b"},{text:"\u9500\u91CF\u6392\u5E8F",value:"c"}];var v=()=>{const[n,d]=l.exports.useState({});return u(r,{value:n,onChange:t=>d(t),children:[e(r.Item,{name:"value1",options:c}),e(r.Item,{name:"value2",options:a})]})};const A=`import React, { useState } from 'react';
...
`,f={code:A,lang:"tsx",dependencies:{react:{type:"NPM",value:"18.1.0"},"react-vant":{type:"NPM",value:"2.0.0-alpha.39"},"index.tsx":{type:"FILE",value:`import React, { useState } from 'react';
import { DropdownMenu } from 'react-vant';
import { option1, option2 } from './options';
...
`}},key:"dropdown-menu-base",meta:{title:"\u57FA\u7840\u7528\u6CD5"}};var D=()=>{const[n,d]=l.exports.useState({});return u(r,{value:n,onChange:t=>d(t),children:[e(r.Item,{name:"value1",options:c}),u(r.Item,{title:"\u7B5B\u9009",name:"value2",children:[e(s,{center:!0,title:"\u5305\u90AE",rightIcon:e(m,{size:24})}),e(s,{center:!0,title:"\u56E2\u8D2D",rightIcon:e(m,{size:24})})]})]})};const I=`import React, { useState } from 'react';
...
`,b={code:I,lang:"tsx",dependencies:{react:{type:"NPM",value:"18.1.0"},"react-vant":{type:"NPM",value:"2.0.0-alpha.39"},"index.tsx":{type:"FILE",value:`import React, { useState } from 'react';
import { DropdownMenu, Cell, Switch } from 'react-vant';
import { option1 } from './options';
...
`}},key:"dropdown-menu-custom",meta:{title:"\u81EA\u5B9A\u4E49\u83DC\u5355\u5185\u5BB9"}};var E=()=>{const[n,d]=l.exports.useState({});return u(r,{activeColor:"#f44336",value:n,onChange:t=>d(t),children:[e(r.Item,{name:"value1",options:c}),e(r.Item,{name:"value2",options:a})]})};const y=`import React, { useState } from 'react';
import { DropdownMenu } from 'react-vant';
import { option1, option2 } from './options';
...
`,R={code:y,lang:"tsx",dependencies:{react:{type:"NPM",value:"18.1.0"},"react-vant":{type:"NPM",value:"2.0.0-alpha.39"},"index.tsx":{type:"FILE",value:`import React, { useState } from 'react';
import { DropdownMenu } from 'react-vant';
import { option1, option2 } from './options';
...
`}},key:"dropdown-menu-color",meta:{title:"\u81EA\u5B9A\u4E49\u9AD8\u4EAE\u989C\u8272"}};var C=()=>{const[n,d]=l.exports.useState({});return u(r,{direction:"up",value:n,onChange:t=>d(t),children:[e(r.Item,{name:"value1",options:c}),e(r.Item,{name:"value2",options:a})]})};const S=`import React, { useState } from 'react';
import { DropdownMenu } from 'react-vant';
import { option1, option2 } from './options';
...
`,_={code:S,lang:"tsx",dependencies:{react:{type:"NPM",value:"18.1.0"},"react-vant":{type:"NPM",value:"2.0.0-alpha.39"},"index.tsx":{type:"FILE",value:`import React, { useState } from 'react';
import { DropdownMenu } from 'react-vant';
import { option1, option2 } from './options';
...
`}},key:"dropdown-menu-direction",meta:{title:"\u5411\u4E0A\u5C55\u5F00"}};var F=()=>{const[n,d]=l.exports.useState({});return u(r,{value:n,onChange:t=>d(t),children:[e(r.Item,{disabled:!0,name:"value1",options:c}),e(r.Item,{disabled:!0,name:"value2",options:a})]})};const P=`import React, { useState } from 'react';
import { DropdownMenu } from 'react-vant';
import { option1, option2 } from './options';
...
`,V={code:P,lang:"tsx",dependencies:{react:{type:"NPM",value:"18.1.0"},"react-vant":{type:"NPM",value:"2.0.0-alpha.39"},"index.tsx":{type:"FILE",value:`import React, { useState } from 'react';
import { DropdownMenu } from 'react-vant';
import { option1, option2 } from './options';
